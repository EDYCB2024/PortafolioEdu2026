...
export function ProfileSidebar({ data, lang }: ProfileSidebarProps) {
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-1 gap-3 md:gap-4">
        <div className="flex items-start gap-3">
          ...
          <div className="flex-1 min-w-0">
            <p className="text-xs text-muted-foreground uppercase mb-1">{labels.email}</p>
            <a
        ...
        <div className="flex items-start gap-3">
          ...
          <div className="flex-1">
            <p className="text-xs text-muted-foreground uppercase mb-1">{labels.location}</p>
