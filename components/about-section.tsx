...
export function AboutSection({ data }: AboutSectionProps) {
  ...
  return (
    <div className="space-y-8 md:space-y-10">
      {/* About Me */}
      <div>
        <h2 className="text-2xl md:text-3xl font-bold text-foreground mb-4">{data.title || "About Me"}</h2>
      ...
      {/* What I'm Doing */}
      <div>
        <h3 className="text-xl md:text-2xl font-bold text-foreground mb-6">{data.servicesTitle || "What I'm Doing"}</h3>
      ...
      {/* Testimonials and Clients (kept same as before, they use base data) */}
      <div>
